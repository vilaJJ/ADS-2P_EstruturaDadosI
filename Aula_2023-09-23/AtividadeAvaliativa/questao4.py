...
# Criando um arranjo com 1000 posições e preenchendo-o com valores aleatórios
# arr = [random.randint(1, 1000) for _ in range(1000)]

# Criando um arranjo com 10000 posições e preenchendo-o com valores aleatórios
