...
# Criando um arranjo com 1000 posições e preenchendo-o com valores de 1 a 1000 ordenadamente
# arr = [i for i in range(1, 1001)]

# Criando um arranjo com 10000 posições e preenchendo-o com valores de 1 a 10000 ordenadamente
# arr = [i for i in range(1, 10001)]

# Criando um arranjo com 100000 posições e preenchendo-o com valores de 1 a 100000 ordenadamente
